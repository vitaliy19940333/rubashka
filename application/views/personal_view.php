...
$(document).ready(function(){
    ...
    <div class="col-xs-12 col-sm-8 col-md-9 ">
		<form onsubmit='checkForm()'  id='register_form' name='form_register' action='/personal/saveData' method='post' style='    background: #fff;
    padding: 15px;
    ...
    margin-bottom: 15px;
    margin-top: 0px;
    padding-top: 5px;'>Личная Информация</h2>
	<p style='color:red'></p>

			<?php $name = explode(" ",$data['user']['name']);?>
			<div class='col-md-12 col-xs-12 col-sm-6'>
				<div class="form-group has-success has-feedback">
				  <label class="control-label" for="inputGroupSuccess1">Ваше имя:</label>
				  <div class="input-group">
					<span class="input-group-addon"><i class="fa fa-user-circle-o" aria-hidden="true"></i></span>
					<input type="text" class="form-control" name="first_name" id="first_name" value='<?=$name[0]?>' aria-describedby="inputGroupSuccess1Status">
				  </div>
			...
			<div class='col-md-12 col-xs-12 col-sm-6'>
				<div class="form-group has-success has-feedback">
				  ...
				  <div class="input-group">
					<span class="input-group-addon"><i class="fa fa-user-circle-o" aria-hidden="true"></i></span>
					<input type="text" class="form-control" name="last_name" value='<?=$name[1]?>'  id="last_name" aria-describedby="inputGroupSuccess1Status">
				  </div>
				  <span class="glyphicon  form-control-feedback" aria-hidden="true"></span>
				  <span id="inputGroupSuccess1Status" class="sr-only">(success)</span>
				</div>
			...
			<div class='col-md-12 col-xs-12 col-sm-6'>
				<div class="form-group has-success has-feedback">
				  ...
				  <div class="input-group">
					...
					<input type="text" class="form-control" name="phone" id="phone"  value='<?=$data['user']['phone']?>' aria-describedby="inputGroupSuccess1Status">
				  </div>
				  <span class="glyphicon  form-control-feedback" aria-hidden="true"></span>
				  <span id="inputGroupSuccess1Status" class="sr-only">(success)</span>
				</div>
			...
			<div class='col-md-12 col-xs-12 col-sm-6'>
				<div class="form-group has-success has-feedback">
				  ...
				  <div class="input-group">
					...
					<input type="text" class="form-control" name="email" id="email_register"  value='<?=$data['user']['login']?>'  aria-describedby="inputGroupSuccess1Status">
				  </div>
				  <span class="glyphicon  form-control-feedback" aria-hidden="true"></span>
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-12"><input type="submit" value="Сохранить" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
			</div>
		</form>
	</div>
